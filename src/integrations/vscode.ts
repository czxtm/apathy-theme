...
import { colorFactory, semanticFactory, strictColorFactory } from "../themes/types";
 ...
 */
function _buildTokenColors(obj: TokenAssignments): VSCodeThemeFile["tokenColors"] {
...
function buildColors(
  ...
  const tokenMap: Record<keyof vscode.VSCodeColors, string> = {
    ...
    "editor.hoverHighlightBackground": c(
      "ui.overrides.editor.lineHighlight",
      "ui.selection.background",
    ),
    "editor.selectionHighlightBorder": c(
    ...
    "editor.findMatchBackground": c(
      "ui.overrides.editor.findMatchBackground",
      "ui.foregrounds.accent",
    ),
    "editor.findMatchHighlightBackground": c(
      "ui.overrides.editor.findMatchHighlightBackground",
      "ui.selection.background",
    ),
    "editor.findRangeHighlightBackground": c(
    ...
    "list.hoverBackground": c(
      "ui.overrides.list.hoverBackground",
      "ui.backgrounds.overlay",
    ),
    "list.hoverForeground": c(
    ...
    // Activity Bar
    // ═══════════════════════════════════════════════════════════════════════
    "activityBar.background": c(
      "ui.overrides.activityBar.background",
      "ui.backgrounds.base",
    ),
    "activityBar.foreground": c(
      "ui.overrides.activityBar.foreground",
      "ui.foregrounds.default",
    ),
    "activityBar.inactiveForeground": c(
    ...
    "activityBarBadge.background": c(
      "ui.overrides.activityBar.badgeBackground",
      "ui.accent.primary",
    ),
    "activityBarBadge.foreground": c(
    ...
    "sideBarSectionHeader.background": c(
      "ui.overrides.sideBar.sectionHeaderBackground",
      "ui.backgrounds.raised",
    ),
    "sideBarSectionHeader.foreground": c(
    ...
    "diffEditorGutter.insertedLineBackground": c(
      "ui.overrides.editorGutter.addedBackground",
      "ui.git.added",
    ),
    "diffEditorGutter.removedLineBackground": c(
      "ui.overrides.editorGutter.deletedBackground",
      "ui.git.deleted",
    ),
    ...
    // "panel.border": c("ui.overrides.panel.border", "ui.borders.default"),
    "panelTitle.activeForeground": c(
      "ui.overrides.panel.titleActiveForeground",
      "ui.foregrounds.default",
    ),
    "panelTitle.inactiveForeground": c(
      "ui.overrides.panel.titleInactiveForeground",
      "ui.foregrounds.muted",
    ),
    "panelTitle.activeBorder": c(
    ...
    "titleBar.activeForeground": c(
      "ui.overrides.titleBar.activeForeground",
      "ui.foregrounds.default",
    ),
    "titleBar.inactiveBackground": c(
      "ui.overrides.titleBar.inactiveBackground",
      "ui.backgrounds.base",
    ),
    "titleBar.inactiveForeground": c(
    ...
    // Status Bar
    // ═══════════════════════════════════════════════════════════════════════
    "statusBar.background": c(
      "ui.overrides.statusBar.background",
      "ui.backgrounds.base",
    ),
    "statusBar.foreground": c(
    ...
    "statusBar.noFolderBackground": c(
      "ui.overrides.statusBar.noFolderBackground",
      "ui.backgrounds.surface",
    ),
    "statusBar.noFolderForeground": c(
    ...
    // Tabs
    // ═══════════════════════════════════════════════════════════════════════
    "tab.activeBackground": c(
      "ui.overrides.tabs.activeBackground",
      "ui.backgrounds.surface",
    ),
    "tab.activeForeground": c(
    ...
    // List
    // ═══════════════════════════════════════════════════════════════════════
    "list.activeSelectionBackground": c(
      "ui.overrides.list.activeSelectionBackground",
      "ui.backgrounds.raised",
    ),
    "list.activeSelectionForeground": c(
      "ui.overrides.list.activeSelectionForeground",
      "ui.foregrounds.default",
    ),
    "list.inactiveSelectionBackground": c(
      "ui.overrides.list.inactiveSelectionBackground",
      "ui.backgrounds.raised",
    ),
    "list.inactiveSelectionForeground": c(
    ...
    "list.focusBackground": c(
      "ui.overrides.list.focusBackground",
      "ui.selection.background",
    ),
    "list.focusForeground": c(
    ...
    "button.secondaryBorder": c(
      "ui.overrides.button.secondaryBorder",
      "ui.borders.default",
    ),
    "button.hoverBackground": c(
      "ui.overrides.button.hoverBackground",
      "ui.accent.primary",
    ),
    "button.secondaryBackground": c(
      "ui.overrides.button.secondaryBackground",
      "ui.backgrounds.raised",
    ),
    "button.secondaryForeground": c(
      "ui.overrides.button.secondaryForeground",
      "ui.foregrounds.default",
    ),
    "button.secondaryHoverBackground": c(
      "ui.overrides.button.secondaryHoverBackground",
      "ui.backgrounds.overlay",
    ),

    "extensionButton.prominentForeground": c(
      "ui.overrides.extensionButton.prominentForeground",
      "ui.overrides.button.foreground",
    ),
    "extensionButton.prominentBackground": c(
      "ui.overrides.extensionButton.prominentBackground",
      "ui.overrides.button.foreground",
    ),
    "extensionButton.foreground": c(
      "ui.overrides.extensionButton.foreground",
      "ui.overrides.button.foreground",
    ),
    "extensionButton.hoverBackground": c(
      "ui.overrides.extensionButton.hoverBackground",
      "ui.overrides.button.hoverBackground",
    ),
    "extensionButton.prominentHoverBackground": c(
      "ui.overrides.extensionButton.prominentHoverBackground",
      "ui.backgrounds.overlay",
    ),
    "extensionButton.separator": c(
      "ui.overrides.extensionButton.separator",
      "ui.borders.default",
    ),
    ...
    // Breadcrumb
    // ═══════════════════════════════════════════════════════════════════════
    "breadcrumb.background": c(
      "ui.overrides.breadcrumb.background",
      "ui.backgrounds.surface",
    ),
    "breadcrumb.foreground": c(
      "ui.overrides.breadcrumb.foreground",
      "ui.foregrounds.muted",
    ),
    "breadcrumb.focusForeground": c(
      "ui.overrides.breadcrumb.focusForeground",
      "ui.foregrounds.default",
    ),
    "breadcrumb.activeSelectionForeground": c(
    ...
    "terminal.selectionBackground": c(
    ...
    // Notifications
    // ═══════════════════════════════════════════════════════════════════════
    "notifications.background": c(
      "ui.overrides.notification.background",
      "ui.backgrounds.overlay",
    ),
    "notifications.foreground": c(
    ...
    // Diff Editor
    // ═══════════════════════════════════════════════════════════════════════
    "diffEditor.insertedTextBackground": c(
      "ui.overrides.diffEditor.insertedTextBackground",
      "ui.git.added",
    ),
    "diffEditor.removedTextBackground": c(
      "ui.overrides.diffEditor.removedTextBackground",
      "ui.git.deleted",
    ),
    "diffEditor.insertedLineBackground": c(
      "ui.overrides.diffEditor.insertedLineBackground",
      "ui.git.added",
    ),
    "diffEditor.insertedTextBorder": c("ui.git.diff.border.added", "ui.git.added"),
    "diffEditor.removedLineBackground": c(
      "ui.overrides.diffEditor.removedLineBackground",
      "ui.git.deleted",
    ),
    "diffEditor.diagonalFill": c(
      "ui.overrides.diffEditor.diagonalFill",
      "ui.borders.subtle",
    ),
    "editorInlayHint.insertedTextBackground": c(
      "ui.overrides.diffEditor.insertedTextBackground",
      "ui.git.added",
    ),
    "editorInlayHint.removedTextBackground": c(
      "ui.overrides.diffEditor.removedTextBackground",
      "ui.git.deleted",
    ),
    "editorInlayHint.insertedLineBackground": c(
      "ui.overrides.diffEditor.insertedLineBackground",
      "ui.git.added",
    ),
    "editorInlayHint.removedLineBackground": c(
      "ui.overrides.diffEditor.removedLineBackground",
      "ui.git.deleted",
    ),
    ...
    "editorSuggestWidget.background": c(
      "ui.suggestWidget.background",
      "ui.backgrounds.raised",
    ),
    "editorIndentGuide.background1": c(
      "ui.indentGuide.background",
      "ui.borders.subtle",
    ),
    "editorIndentGuide.activeBackground1": c(
    ...
    "gitDecoration.ignoredResourceForeground": c(
      "ui.git.ignored",
      "ui.foregrounds.subtle",
    ),
    ...
    "gitDecoration.stageModifiedResourceForeground": c(
      "ui.git.stageModified",
      "ui.git.modified",
    ),
    "gitDecoration.stageDeletedResourceForeground": c(
      "ui.git.stageDeleted",
      "ui.git.deleted",
    ),
    "gitDecoration.submoduleResourceForeground": c(
      "ui.git.submodule",
      "ui.foregrounds.muted",
    ),
    ...
    "menu.selectionBackground": c(
      "ui.menu.selectionBackground",
      "ui.selection.background",
    ),
    "menu.selectionForeground": c(
      "ui.menu.selectionForeground",
      "ui.foregrounds.default",
    ),
    "menu.separatorBackground": c(
    ...
    "editorSuggestWidget.foreground": c(
      "ui.suggestWidget.foreground",
      "ui.foregrounds.default",
    ),
    "editorSuggestWidget.selectedBackground": c(
    ...
    // Debug Console
    // ═══════════════════════════════════════════════════════════════════════
    "debugConsole.infoForeground": c(
      "ui.debug.infoForeground",
      "ui.status.info.foreground",
    ),
    "debugConsole.warningForeground": c(
      "ui.debug.warningForeground",
      "ui.status.warning.foreground",
    ),
    "debugConsole.errorForeground": c(
      "ui.debug.errorForeground",
      "ui.status.error.foreground",
    ),
    "debugConsole.sourceForeground": c(
    ...
    "textPreformat.background": c(
      "ui.text.preformatBackground",
      "ui.backgrounds.raised",
    ),
    "textPreformat.foreground": c(
      "ui.text.preformatForeground",
      "ui.foregrounds.default",
    ),
    "textSeparator.foreground": c(
    ...
    // Peek View Extended
    // ═══════════════════════════════════════════════════════════════════════
    "peekViewEditor.matchHighlightBackground": c(
      "ui.peekView.matchHighlightBackground",
      "ui.selection.background",
    ),
    "peekViewResult.matchHighlightBackground": c(
      "ui.peekView.matchHighlightBackground",
      "ui.selection.background",
    ),
    "peekViewTitleDescription.foreground": c(
...
function generateVSCodeTheme(t: ThemeDefinition): VSCodeThemeFile {
  ...
  return {
    ...
    tokenColors: [
      ...
      tokenColor("variable.parameter", c("tokens.variables.parameter"), "italic"),
      ...
      // Classes & Types
      tokenColor("entity.name.class", c("tokens.types.class"), "bold underline"),
      tokenColor(
      ...
      tokenColor(
        ...
        sc("tokens.special.jsxClass", "tokens.types.class"),
      ),
      tokenColor(
      ...
      tokenColor("punctuation.definition.decorator", c("tokens.meta.decorator")),
