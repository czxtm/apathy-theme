...
function buildColors(
	...
	const tokenMap: Record<keyof vscode.VSCodeColors, string> = {
		...
		// Error Display
		// ═══════════════════════════════════════════════════════════════════════
		"editorError.background": c(
			"ui.error.background",
			"ui.status.error.background",
		),
		"list.errorForeground": c(
	...
	return {
		...
		tokenColors: [
			...
			tokenColor(
				...
				c("tokens.punctuation.definition"),
			),
