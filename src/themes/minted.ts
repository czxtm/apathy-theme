...
const gitDiffBg = (() => {
  ...
  return {
    added: oklch(l, c, hues.added),
    deleted: oklch(l, c, hues.deleted),
    modified: oklch(l, c, hues.modified),
  };
})();

const git = (() => {
  const status = {
    added: oklch(0.799, 0.076, 178.7).alpha(0.918).render(),
    modified: oklch(0.627, 0.076, 271.0).alpha(0.957).render(),
  ...
  const diffeditorbg = {
    added: oklch(0.582, 0.078, 170.2).alpha(0.812).render(),
    deleted: oklch(0.786, 0.098, 8.2).alpha(0.918).render(),
    modified: oklch(0.901, 0.098, 8.2).alpha(0.918).render(),
    removedText: oklch(0.128, 0.024, 20.9).render(),
  };
  const diffeditorborder = {
    insertedTextBorder: oklch(0.282, 0.035, 180.2).alpha(0.133).render(),
  ...
  const gutterbg = {
    ...
    deleted: oklch(0.786, 0.098, 8.2).alpha(0.918).render(),
    modified: oklch(0.901, 0.098, 8.2).alpha(0.918).render(),
    insertedLine: oklch(0.165, 0.027, 190.4).alpha(0.886).render(),
    deletedLine: oklch(0.149, 0.023, 189.7).alpha(0.667).render(),
    modifiedLine: oklch(0.268, 0.032, 192.1).alpha(0.259).render(),
    removedLine: oklch(0.149, 0.023, 189.7).alpha(0.667).render(),
  };
  const border = {
    insertedTextBorder: oklch(0.282, 0.035, 180.2).alpha(0.133).render(),
    removedTextBorder: oklch(0.223, 0.056, 8.3).alpha(0.133).render(),
...
const ui: UserInterface<ColorLike> = {
  ...
  git: {
    ...
    diff: {
      ...
      border: {},
      wordHighlight: {
        added: oklch(0.45, 0.07, 258).alpha(0.21),
...
const components = {
  ...
  editorGutter: {
    ...
    addedBackground: gitDiffBg.added,
    deletedBackground: gitDiffBg.deleted,
    modifiedBackground: gitDiffBg.modified,
    // addedBackground: oklch(0.125, 0.04, 165),
    // deletedBackground: oklch(0.12, 0.03, 6),
...
const mintedSource = {
  ...
  extraColors: {
    ...
    "editorGutter.addedBackground": oklch(0.582, 0.078, 170.2)
      .alpha(0.812)
      .render(),
    "minimapGutter.addedBackground": oklch(0.381, 0.048, 170.6).render(),
    "gitlens.decorations.addedForegroundColor": oklch(0.899, 0.081, 183.3)
      .alpha(0.918)
      .render(),
    "diffEditorGutter.insertedLineBackground": oklch(0.165, 0.027, 190.4)
      .alpha(0.886)
      .render(),
    "diffEditor.insertedLineBackground": oklch(0.149, 0.023, 189.7)
      .alpha(0.667)
      .render(),
    "diffEditor.insertedTextBackground": oklch(0.268, 0.032, 192.1)
      .alpha(0.259)
      .render(),
    "diffEditor.insertedTextBorder": oklch(0.282, 0.035, 180.2)
      .alpha(0.133)
      .render(),
    "diffEditorGutter.removedLineBackground": oklch(0.209, 0.058, 9.8)
      .alpha(0.706)
      .render(),
    "diffEditor.removedLineBackground": oklch(0.128, 0.024, 20.9).render(),
    "diffEditor.removedTextBorder": oklch(0.223, 0.056, 8.3)
      .alpha(0.133)
      .render(),
    "diffEditor.removedTextBackground": oklch(0.166, 0.054, 3.3)
      .alpha(0.733)
      .render(),
  },
