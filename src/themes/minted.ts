...
const hue = {
  ...
  amber: {
    conflictBackground: 45.2,
    conflictTheirs: 102.2,
...
const syntax: SlimThemeDefinition["syntax"] = {
  ...
  strings: {
    default: oklch(0.857, 0.019, hue.green.iconAccent).alpha(0.933),
    regex: mp.peach,
  },
  operators: {
  ...
  literals: {
    ...
    string: oklch(0.857, 0.019, hue.green.iconAccent).alpha(0.933),
  ...
  variables: {
    default: oklch(0.589, 0.075, hue.violet.variableZed),
    local: oklch(0.589, 0.075, hue.violet.variableZed),
    parameter: oklch(0.589, 0.075, hue.violet.variableZed),
    property: oklch(0.617, 0.06, hue.violet.property).alpha(0.8),
    global: oklch(0.589, 0.075, hue.violet.variableZed),
  ...
  punctuation: {
    ...
    definition: oklch(0.355, 0.03, hue.violet.punctuationDefinition).alpha(0.82),
  ...
  meta: {
    ...
    label: oklch(0.913, 0.035, hue.magenta.title).alpha(0.667),
    tag: mp.gray1,
  },
  storage: {
    default: mp.bluegray,
...
const foregrounds: UserInterface<ColorLike>["foregrounds"] = {
  ...
  accent: oklch(0.886, 0.13, hue.green.textAccent),
  focused: focusColor,
};
...
const git = (() => {
  const status = {
    ...
    conflict: oklch(0.581, 0.188, hue.red.conflict).alpha(0.706),
  ...
  const diffeditorborder = {
    ...
    removedTextBorder: oklch(0.223, 0.056, hue.red.diffDeletedBorder).alpha(0.133),
  };
  const gutterbg = {
    added: oklch(0.1654, 0.0265, hue.cyan.gitDiffAdded).alpha(0.341),
    deleted: oklch(0.786, 0.098, hue.red.diffDeleted).alpha(0.918),
...
const ui: UserInterface<ColorLike> = {
  ...
  status: {
    ...
    conflict: statusTone(
      oklch(0.282, 0.039, hue.amber.conflictTheirs).alpha(0.706),
      oklch(0.365, 0.08, hue.amber.conflictBackground).alpha(0.918),
      oklch(0.176, 0.041, hue.blue.conflictOurs).alpha(0.886),
    ),
  },
  selection: {
    ...
    text: mp.charcoal,
    backgroundActive: oklch(0.244, 0.038, hue.violet.activeSelection).alpha(0.33),
  ...
  git: {
    ...
    files: {
      foreground: {
        ...
        conflict: oklch(0.789, 0.1, hue.red.conflict).alpha(0.918),
        renamed: git.files.fg.renamed,
      },
    },
    diff: {
  ...
  inlineHints: {
    background: oklch(0.558, 0.0752, hue.violet.inlineHintBackground).alpha(0.031),
    foreground: oklch(0.6835, 0.1348, hue.violet.inlayHintForeground).alpha(0.384),
  ...
  subtleElements: {
    ...
    selectionBackground: oklch(0.2196, 0.0516, hue.violet.activeLine).alpha(0.329),
    selected: {
...
const components = {
  ...
  editorWidget: {
    ...
    foreground: oklch(0.9333, 0.036, hue.cyan.editorWidgetForeground).alpha(0.718),
  ...
  sideBar: {
    background: mp.midnightSlightlyDark,
  ...
  button: {
    ...
    secondaryBorder: oklch(0.4099, 0.0118, hue.violet.buttonBorder).alpha(0.471),
  },
  extensionButton: {
    prominentForeground: mp.mist,
    prominentBackground: mp.white,
  },
  dropdown: {
    background: mp.midnight,
    foreground: mp.mist.alpha(0.76),
  ...
  terminal: {
    ...
    foreground: oklch(0.7526, 0.0486, hue.violet.terminalForeground).alpha(0.922),
    ...
    ansiBrightGreen: oklch(0.8953, 0.1272, hue.green.terminalBrightGreen).alpha(0.796),
    ...
    ansiBrightMagenta: oklch(0.591, 0.2278, hue.magenta.terminalBrightMagenta).alpha(
      0.812,
    ),
...
const mintedSource = {
  ...
  extraColors: {
    ...
    "diffEditor.insertedLineBackground": components.diffEditor.insertedLineBackground,
    "diffEditor.insertedTextBackground": components.diffEditor.insertedTextBackground,
    "diffEditor.insertedTextBorder": components.diffEditor.insertedTextBorder,
    "diffEditorGutter.removedLineBackground": oklch(0.209, 0.058, hue.red.removedGutter)
      .alpha(0.706)
      .render(),
    ...
    "diffEditor.removedTextBorder": oklch(0.223, 0.056, hue.red.diffDeletedBorder)
      .alpha(0.133)
      .render(),
