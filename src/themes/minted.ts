...
export enum palette {
	...
	misty = "#8692aee8", // luminance ~149 #7f8797
	fg = "#545c6ee6",
	fgbright = "#c4c9d6e8",
	fgsubtle = "#8692aee8",
...
const core = {
	...
	foreground: colors.fg.mix(colors.midnight, 0.2),
...
const foregrounds: UserInterface<ColorLike>["foregrounds"] = {
	default: colors.fg.mix(colors.midnight, 0.1),
...
const accent: UserInterface<ColorLike>["accent"] = {
	...
	palette: ["#88e6d6", "#C3E88D", "#ffb389", "#F07178", "#6bffbfdb", "#8b00ff"],
};
...
const components: UIComponents<ColorLike> = {
	editor: {
		...
		findMatchHighlightBackground: transparentize(
			mix(palette.lavender, ui.backgrounds.base, 0.8),
			0.5,
		),
	...
	editorGutter: {
		...
		addedBackground: "#01060a",
		deletedBackground: "#12070f",
	...
	diffEditor: {
		insertedTextBackground: "#040c11",
		removedTextBackground: "#0f050c",
		insertedLineBackground: "#040c11",
		removedLineBackground: "#0f050c",
		diagonalFill: palette.alphaWhite,
	},
	merge: (() => {
